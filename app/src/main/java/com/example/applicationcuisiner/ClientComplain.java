...
public class ClientComplain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.client_complain);
    ...
    protected void onStart() {
        ...
        databsePlaintes.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                PlainteList productsAdapter = new PlainteList(ClientComplain.this, plaintes);
            }
