...
public class RepasListAdapterforRepas  extends ArrayAdapter<Repas> {
    ...
    public RepasListAdapterforRepas(@NonNull Context context, ArrayList<Repas> RepasArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        listitemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                popupMenu.getMenuInflater().inflate(R.menu.popup_repas_propose, popupMenu.getMenu());
